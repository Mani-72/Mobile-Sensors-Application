...
import com.example.mobilesensorapplication.BuildConfig;
...
public class CameraHelper {
    private static final String TAG = com.example.mobilesensorapplication.VideoRecording.CameraHelper.class.getSimpleName();
    ...
    public static File getOutputMediaFile(String fileName, int type) {
        ...
        //TODO (Change the file name here, to save the results with sensor data)
       /* File mediaStorageDir = new File(Environment.getExternalStoragePublicDirectory(
                Environment.DIRECTORY_PICTURES), BuildConfig.APPLICATION_ID);*/

        File mediaStorageDir = new File(Environment.getExternalStorageDirectory() + "/Mani/edata/data/SensorApplicationDownloadResults");
        ...
        Log.i("ErrorCheck", "getOutputMediaFile: ");
